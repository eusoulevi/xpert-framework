...
public class ErroSistema implements Serializable {
    ...
    private static final String PACOTE_PADRAO_SISTEMA = "${package}";
            ...
            try {
                ...
                while ((linha = bufferedReader.readLine()) != null) {
                    if (linha.contains(PACOTE_PADRAO_SISTEMA)) {
                        stringBuilder.append("<span style='background: ${symbol_pound}EEDD82'>").append(linha.replace(PACOTE_PADRAO_SISTEMA, "<b>" + PACOTE_PADRAO_SISTEMA + "</b>")).append("</span>");
                    } else {
